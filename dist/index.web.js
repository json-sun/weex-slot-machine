...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-slot-machine/src/slot-machine/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0d1eb33f", Component.options)
  } else {
    hotAPI.reload("data-v-0d1eb33f", Component.options)
  }
...
var update = __webpack_require__(5)("cb2ff2e0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0d1eb33f\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0d1eb33f\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
...
// module
exports.push([module.i, "\n.slot-machine--wrap[data-v-0d1eb33f] {\n  overflow: hidden;\n  -ms-flex-direction: row;\n      flex-direction: row;\n  -ms-flex-align: end;\n      align-items: flex-end;\n  background-color: #58595b;\n}\n", ""]);
...
var _slotMachine = __webpack_require__(17);
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      states: _config2.default.slotMachineStates,
      state: 'idle',
      engine: null,
      slotMachine: null
    };
  ...
  created: function created() {
    ...
    var mergeConfig = Object.assign({}, _config2.default, {
      slotMachine: {
        width: this.width,
        height: this.height,
    ...
    this.engine = new _engine2.default(mergeConfig);
    this.slotMachine = new _slotMachine2.default(this, mergeConfig);

    this.engine.api.getConfig().then(function (data) {
      return _this.slotMachine.updateData(data);
    });
  ...
  mounted: function mounted() {
    ...
    setTimeout(function () {
      _this2.slotMachine.setElements(Object.values(_this2.$refs).map(function (ref) {
        return ref[0];
      }));
    }, 200);
  },
  ...
  methods: {
    spin: function spin(linesToWin) {
      var _this3 = this;

      if (this.slotMachine.state !== _config2.default.slotMachineStates.IDLE) {
        return;
      }
      // 确保胜利 更新胜利之后的图组
      linesToWin && this.engine.api.getSpinEndData(linesToWin).then(function (data) {
        _this3.slotMachine.updateEndData(data);
      });
      // 开始滚动
    ...
    stop: function stop() {
      ...
      if (this.slotMachine.state !== _config2.default.slotMachineStates.SPIN) {
        return;
      }
      this.slotMachine.stop().then(function () {
        _this4.$emit('wxSlotMachineStopped');
      });
    },
    getSymbolUrl: function getSymbolUrl(key) {
...
var SlotMacnineEngine = function () {
	function SlotMacnineEngine(config) {
		var _this = this;

		_classCallCheck(this, SlotMacnineEngine);

		var self = this;
		this.config = {
			width: config.slotMachine.width || 3,
			height: config.slotMachine.height || 3,
			availableSymbols: _symbols2.default
		};
		...
		this.api = {
			getConfig: function getConfig() {
				_this.generateReels.call(_this);
				return Promise.resolve(_this.state);
			},
			getSpinEndData: function getSpinEndData(linesToWin) {
				_this.generateReels.call(_this, linesToWin);
				_this.countWinLines.call(_this);
				return Promise.resolve(self.state);
			}
		};
	}

	_createClass(SlotMacnineEngine, [{
		key: 'getRandomSymbol',
		value: function getRandomSymbol() {
			var index = getRandomInt(0, this.config.availableSymbols.length - 1);
			return this.config.availableSymbols[index].key;
		}
	}, {
		key: 'generateSymbolOnReel',
		value: function generateSymbolOnReel(reel) {
			var newSymbol = this.getRandomSymbol();
		...
		key: 'generateReels',
		value: function generateReels(linesToWin) {
			// 清除之前的图组
			this.reels.splice(0);
			...
			if (linesToWin) {
				var winSymbol = this.generateSymbolOnReel(this.reels[0]);
				for (var _i = 0; _i < linesToWin.length; _i++) {
					for (var j = 0; j < this.config.width; j++) {
						this.reels[j][linesToWin[_i]] = winSymbol;
					}
				}
			}

			for (var _i2 = 0; _i2 < this.config.width; _i2++) {
				for (var _j = 0; _j < this.config.height; _j++) {
					if (!this.reels[_i2][_j]) {
						this.reels[_i2][_j] = this.generateSymbolOnReel(this.reels[_i2]);
					}
				}
			}
			return this.reels;
		...
		key: 'countWinLines',
		value: function countWinLines() {
			this.winlines.splice(0);
			for (var i = 0; i < this.reels.length; i++) {
				var symbol = this.reels[0][i];
				var isWinLine = true;
				for (var j = 1; j < this.reels.length; j++) {
	...
	return SlotMacnineEngine;
}();

exports.default = SlotMacnineEngine;
...
var _reel = __webpack_require__(18);
...
var SlotMachineView = function () {
	function SlotMachineView(app, config) {
	...
	_createClass(SlotMachineView, [{
		...
		value: function initialize() {
			for (var i = 0; i < this.reelsCount; i++) {
				this.reels.push(new _reel2.default(this.app.symbols));
			}
		}
	}, {
		key: 'setElements',
		...
		key: 'updateEndData',
		value: function updateEndData(data) {
			for (var i = 0; i < this.reels.length; i++) {
				this.reels[i].stopSymbols = data.reels[i];
			}
		}
		...
		value: function spin() {
			...
			this.state = _config2.default.slotMachineStates.SPIN;
		...
		value: function stop() {
			...
			var stopCount = 0;
			return new Promise(function (resolve) {
				_this2.state = _config2.default.slotMachineStates.STOPPING;

				var _loop2 = function _loop2(i) {
					var delay = i * 1000;
					setTimeout(function () {
						_this2.reels[i].stop().then(function () {
							stopCount++;
							if (stopCount === _this2.reelsCount) {
								_this2.state = _config2.default.slotMachineStates.IDLE;
								resolve();
							}
						});
					}, delay);
				...
				for (var i = 0; i < _this2.reelsCount; i++) {
					_loop2(i);
				}
			});
		}
...
exports.default = SlotMachineView;
...
var _weexBindingx = __webpack_require__(19);
...
var Reel = function () {
	function Reel(symbols) {
		...
		this.spinningSpeed = _config2.default.slotMachine.spinSpeed;
		this.reelSpinMargin = _config2.default.slotMachine.reelMargin;
		this.height = _config2.default.slotMachine.height;
		this.symbolSize = _config2.default.slotMachine.symbolWidth;
		this.availableSymbols = symbols;

		this.spinningState = _config2.default.spinningStates.IDLE;
		this.position = 0;
		this.symbols = [];
		this.stopSymbols = [];
		this.element = null;
	...
	_createClass(Reel, [{
		...
		value: function isIdle() {
			return this.spinningState === _config2.default.spinningStates.IDLE;
		}
	}, {
		key: 'spin',
		value: function spin() {
			this.spinningState = _config2.default.spinningStates.STARTING;
			this.loop();
		}
	}, {
		key: 'stop',
		value: function stop() {
			this.spinningState = _config2.default.spinningStates.STOPPING;
		...
		value: function loop() {
			...
			this.excuAnimate(-this.reelSpinMargin, 400).then(function () {
				return _this.excuAnimate(_this.reelHeight, 120, 'easeInCubic');
			}).then(function () {
				if (platform === 'Web') {
					_this.looping = true;
					var infinitely = function infinitely() {
						_this.excuAnimate(_this.reelTapeHeight + _this.reelHeight, 600).then(function () {
							setTimeout(function () {
								_this.looping && infinitely();
							});
						});
					};
					infinitely();
				} else {
					_this.excuAnimate(_this.reelTapeHeight + _this.reelHeight, 600);
		...
		value: function stopping() {
			...
			this.looping = false;
			return this.excuAnimate(this.reelTapeHeight + this.reelHeight, 600).then(function () {
				return _this2.excuAnimate(_this2.reelTapeHeight * 2 + _this2.reelHeight, 7000, 'easeOutQuint');
			}).then(function () {
				_this2.symbols = _this2.stopSymbols;
				setTimeout(function () {
					_this2.position = 0;
					if (platform === 'Web') {
						_this2.element.$el.style.transform = 'translateY(0px)';
					} else {
						animation.transition(_this2.element, {
							styles: {
								transform: 'translateY(' + _this2.position + 'px)'
							},
							duration: 0
						});
					}
		...
		key: 'excuAnimate',
		value: function excuAnimate(nextPosition, duration) {
			var timingFunc = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'linear';
			var c1 = arguments[3];
			var c2 = arguments[4];
			...
			return new Promise(function (resolve) {
				var changeY = nextPosition - _this3.position;

				var expression = !(c1 && c2 && c3 && c4 && timingFunc === 'cubicBezier') ? timingFunc + '(t, ' + _this3.position + ', ' + changeY + ', ' + duration + ')' : 'cubicBezier(t, ' + _this3.position + ', ' + changeY + ', ' + duration + ', ' + c1 + ', ' + c2 + ', ' + c3 + ', ' + c4 + ')';

				var gesToken = _weexBindingx2.default.bind({
					eventType: 'timing',
					exitExpression: 't>' + duration,
					props: [{
						element: _this3.element.ref,
					...
					if (e.state === 'exit') {
						...
						_this3.position = nextPosition;
						if (_this3.position >= _this3.reelTapeHeight + _this3.reelHeight) {
							_this3.position = _this3.reelHeight;
						}
						resolve();
					}
				});
		...
		key: 'excuAnimateH5',
		value: function excuAnimateH5(nextPosition, duration) {
			var _this4 = this;
			...
			return new Promise(function (resolve) {
				animation.transition(_this4.element, {
					styles: {
						transform: 'translateY(' + _this4.position + 'px)'
					},
					duration: duration,
					timingFunction: timingFunc
				}, function () {
					if (_this4.position >= _this4.reelTapeHeight + _this4.reelHeight && _this4.position < _this4.reelTapeHeight * 2 + _this4.reelHeight) {
						_this4.position = _this4.reelHeight;
						animation.transition(_this4.element, {
							styles: {
								transform: 'translateY(' + _this4.position + 'px)'
							},
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "slot-machine--wrap",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle({
      width: ((_vm.width * _vm.itemSize) + "px"),
      height: ((_vm.height * _vm.itemSize) + "px")
    }))
  }, _vm._l((_vm.slotMachine.reels), function(reel, reelIndex) {
    return _c('div', {
      key: reelIndex,
      staticClass: "slot-machine--col",
      staticStyle: _vm.$processStyle(undefined),
      ...
      staticStyle: _vm.$processStyle(undefined),
      style: (_vm.$processStyle(undefined))
    }, [_vm._l((reel.stopSymbols), function(symbol, index) {
      return _c('div', {
        staticClass: "col-symbol",
        staticStyle: _vm.$processStyle(undefined),
        style: (_vm.$processStyle(undefined))
      }, [_c('image', {
        staticClass: "col-symbol--img",
        staticStyle: _vm.$processStyle(undefined),
        style: (_vm.$processStyle(_vm.itemStyle)),
        attrs: {
          "src": _vm.getSymbolUrl(symbol)
        }
      })])
    }), _vm._v(" "), _vm._l((_vm.symbols), function(symbol) {
      return _c('div', {
        staticClass: "col-symbol",
        staticStyle: _vm.$processStyle(undefined),
        style: (_vm.$processStyle(undefined))
    ...
    }), _vm._v(" "), _vm._l((reel.symbols), function(symbol, index) {
      return _c('div', {
        staticClass: "col-symbol",
        staticStyle: _vm.$processStyle(undefined),
        style: (_vm.$processStyle(undefined))
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0d1eb33f", module.exports)
  }
}
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-slot-machine/src/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-03522c3e", Component.options)
  } else {
    hotAPI.reload("data-v-03522c3e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("da16146a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-03522c3e\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-03522c3e\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.wrapper[data-v-03522c3e] {\n  -ms-flex-align: center;\n      align-items: center;\n}\n.title[data-v-03522c3e] {\n  font-size: 48px;\n  text-align: center;\n  color: #333333;\n  margin-top: 200px;\n}\n.sub-title[data-v-03522c3e] {\n  font-size: 32px;\n  text-align: center;\n  color: #999999;\n  margin-top: 20px;\n}\n.content[data-v-03522c3e] {\n  -ms-flex-align: center;\n      align-items: center;\n  margin-top: 60px;\n}\n.control[data-v-03522c3e] {\n  margin-top: 60px;\n  width: 500px;\n  -ms-flex-direction: row;\n      flex-direction: row;\n  -ms-flex-pack: justify;\n      justify-content: space-between;\n}\n.btn[data-v-03522c3e] {\n  width: 200px;\n  height: 100px;\n  border-radius: 50px;\n  -ms-flex-align: center;\n      align-items: center;\n  -ms-flex-pack: center;\n      justify-content: center;\n}\n.btn-text[data-v-03522c3e] {\n  color: #FFF;\n  font-size: 38px;\n}\n", ""]);
...
var _slotMachine = __webpack_require__(26);
...
exports.default = {
  name: 'App',
  components: {
    SlotMachine: _slotMachine2.default
  },
  data: function data() {
    return {
      state: 'idle'
  ...
  methods: {
    start: function start() {
      this.$refs['slot-machine'].spin([1]);
    },
    stop: function stop() {
      this.$refs['slot-machine'].stop();
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("Weex Slot-Machine")]), _vm._v(" "), _c('text', {
    staticClass: "sub-title",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("( Weex 老虎机 )")]), _vm._v(" "), _c('div', {
    staticClass: "content",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_c('SlotMachine', {
    ...
    style: (_vm.$processStyle(undefined)),
    on: {
      "wxSlotMachineStateChanged": _vm.stateChanged
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: "control",
    staticStyle: _vm.$processStyle(undefined),
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle({
      backgroundColor: _vm.state === 'idle' ? '#666' : '#999'
    })),
    on: {
      "click": _vm.start
    }
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle({
      backgroundColor: _vm.state === 'spin' ? '#666' : '#999'
    })),
    on: {
      "click": _vm.stop
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-03522c3e", module.exports)
  }
}
